...
async function main() {
    ...
    try {
        ...
        app.get("/", (req, res) => {
            ...
            res.sendFile(__dirname + "/movie-list.html");
        });
        ...
        app.get("/book-seats-form.html", (req, res) => {
            res.sendFile(__dirname + "/book-seat-form.html");
        });
        ...
        app.post("/book-seats", async (req, res) => {
            try {
                ...
                //console.log("Movie name to book:", movieNameToBook); // Log tên phim
                ...
                if (seatsToBook <= availableSeats) {
                    ...
                    return res.send(`Not enough seats available for ${seatsToBook} seat(s) in ${movieNameToBook}` // This will display message
                    );
                }
            } catch (error) {
